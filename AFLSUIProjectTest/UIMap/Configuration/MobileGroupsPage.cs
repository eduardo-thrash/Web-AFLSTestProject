namespace AAFLSUIProjectTest.UIMap.Configuration
{
    public class MobileGroupPage
    {
        ...
        public string MobileGroupsState = "//div[@class='groupsMovil']//div[@id='tabs-1']//label[@class='onoffswitch-label']";
        ...
        public string MobileGroupsUsersAutocomplete = "//div[@class='groupsMovil']//div[@id='tabs-3']//input[@class='._specSearch specSearch ui-autocomplete-input']";
        public string MobileGroupsUsersOption = "//li/a[@class='ui-corner-all']";
        ...
        public string MobileGroupsSkill = "//div[@class='groupsMovil']//div[@id='tabs-4']//input[@name='Skills']";
        public string MobileGroupsSkillOption = "//li/a[@class='ui-corner-all' and contains(text(),' ')]";
