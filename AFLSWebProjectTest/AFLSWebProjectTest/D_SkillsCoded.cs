...
namespace AFLSWebProjectTest
{
    ...
    [DeploymentItem("aflswebprojecttest\\SkillsData.csv", "aflswebprojecttest")]
    [DataSource("DataSourceSkills", "Microsoft.VisualStudio.TestTools.DataSource.CSV", "|DataDirectory|\\aflswebprojecttest\\SkillsData.csv", Microsoft.VisualStudio.TestTools.WebTesting.DataBindingAccessMethod.Sequential, Microsoft.VisualStudio.TestTools.WebTesting.DataBindingSelectColumns.SelectOnlyBoundColumns, "SkillsData#csv")]
    public class D_SkillsCoded : WebTest
    {

        public D_SkillsCoded()
        {
            this.Context.Add("WebServer1", "http://localhost");
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request1 = new WebTestRequest((this.Context["WebServer1"].ToString() + this.Context["Instance"].ToString()));
            request1.ThinkTime = 1;
            request1.ExpectedResponseUrl = (this.Context["WebServer1"].ToString()
            ...
            conditionalRule1.IterationsCount = 67D;

            int maxIterations1 = -1;
            bool advanceDataCursors1 = true;
            this.BeginLoop(conditionalRule1, maxIterations1, advanceDataCursors1);
            this.RegisterDataSourceInLoop(conditionalRule1, "DataSourceSkills", "SkillsData#csv");

            for (; this.ExecuteConditionalRule(conditionalRule1);)
            {
                WebTestRequest request3 = new WebTestRequest((this.Context["WebServer1"].ToString()
                                + (this.Context["Instance"].ToString() + "Skills/Save")));
                ...
                request3.Headers.Add(new WebTestRequestHeader("Referer", (this.Context["WebServer1"].ToString() + this.Context["Instance"].ToString())));
                ...
                request3Body.BodyString = ("{\r\n  \"Name\": \""
                            + (this.Context["DataSourceSkills.SkillsData#csv.Name"].ToString()
                            + ("\",\r\n  \"Description\": \""
                            + (this.Context["DataSourceSkills.SkillsData#csv.Description"].ToString() + "\",\r\n  \"IsActive\": true,\r\n  \"selected\": true\r\n}"))));
