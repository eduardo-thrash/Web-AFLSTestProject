...
namespace AFLSWebProjectTest
{
    ...
    public class F_QuickAnswersCoded : WebTest
    {

        public F_QuickAnswersCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request3 = new WebTestRequest((this.Context["Url"].ToString()
                            + (this.Context["Instance"].ToString() + "QuickAnswers/Save")));
            ...
            request3Body.BodyString = "{\"Name\":\"Servicio 1\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":null,\"Descr" +
                "iption\":\"Servicio 1\",\"Enable\":true,\"selected\":true,\"ServiceName\":\"\"}";
            ...
            request4Body.BodyString = "{\"Name\":\"Servicio 2\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":null,\"Descr" +
                "iption\":\"Servicio 2\",\"Enable\":true,\"selected\":true,\"ServiceName\":\"\"}";
            ...
            request5Body.BodyString = "{\"Name\":\"Servicio 3\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":2,\"ObjectId\":null,\"Descr" +
                "iption\":\"Servicio 3\",\"Enable\":true,\"selected\":true,\"ServiceName\":\"\"}";
            ...
            request6Body.BodyString = "{\"Name\":\"Servicio 4\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":null,\"Descr" +
                "iption\":\"Servicio 4\",\"Enable\":true,\"selected\":true,\"ServiceName\":\"\"}";
            ...
            request7Body.BodyString = "{\"Name\":\"Respuesta de prueba\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":nu" +
                "ll,\"Description\":\"Respuesta de prueba\",\"Enable\":true,\"selected\":true,\"ServiceNam" +
                "e\":\"\"}";
            ...
            request8Body.BodyString = "{\"Name\":\"Respuesta de prueba1\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":n" +
                "ull,\"Description\":\"Respuesta de prueba1\",\"Enable\":true,\"selected\":true,\"ServiceN" +
                "ame\":\"\"}";
            ...
            request9Body.BodyString = "{\"Name\":\"Respuesta de prueba2\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":n" +
                "ull,\"Description\":\"Respuesta de prueba2\",\"Enable\":true,\"selected\":true,\"ServiceN" +
                "ame\":\"\"}";
            ...
            request10Body.BodyString = "{\"Name\":\"Respuesta de prueba3\",\"Service\":{\"Id\":0,\"Name\":\"\"},\"Type\":1,\"ObjectId\":n" +
                "ull,\"Description\":\"Respuesta de prueba3\",\"Enable\":true,\"selected\":true,\"ServiceN" +
                "ame\":\"\"}";
